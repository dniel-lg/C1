...
ggplot(data = datos_grafico, aes(x = Var1, y = Freq, group = Var2, color = Var2)) +
  geom_line() +
  labs(title = "Nivel de Ingresos y Frecuencia de Uso de la Tarjeta",
       x = "Nivel de Ingresos",
       y = "Frecuencia",
       color = "Frecuencia de Uso") +
  scale_color_manual(values = c("#EFF3FF", "#C6DBEF", "#9ECAE1", "#6BAED6", "#4292C6", "#08519C"),
                     labels = c("Muy poco uso", "Poco uso", "Mediano uso", "Bastante uso", "Frecuente uso"))
